...
<body class="home page-template-default page page-id-3075 woocommerce-no-js ppb_enable">
    ...
    <div class="ppb_wrapper  ">
                ...
                <div class="page_content_wrapper">
                    <div class="inner">
                        <div style="margin:auto;width:100%">
                            <h2 class="ppb_title" style="">{{__('home.mar.title')}}</h2>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="one">
            <div class="one_half_bg parallax" style="background-image:url({{asset('images/air/mar-s.jpg')}});height:550px;"></div>
            <div class="one_half_bg" style="padding:80px;">
                <h2 class="ppb_title" style="">{{__('home.mar.name')}}</h2>
