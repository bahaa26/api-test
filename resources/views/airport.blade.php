...
<body class="home page-template-default page page-id-3075 woocommerce-no-js ppb_enable">
    ...
    <div class="ppb_wrapper  ">
                ...
                <div class="page_content_wrapper">
                    <div class="inner">
                        <div style="margin:auto;width:100%">
                            <h2 class="ppb_title" style="">{{__('home.air.title')}}</h2>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="one">
            <div class="one_half_bg parallax" style="background-image:url({{asset('images/air/one.jpg')}});height:550px;"></div>
            <div class="one_half_bg" style="padding:80px;">
                <h2 class="ppb_title" style="">{{__('home.air.cairo.title')}}</h2>
                <div class="ppb_header_content">
                    <p>{{__('home.air.cairo.one')}}</p>
                    <p>{{__('home.air.cairo.two')}}</p>
                </div>
            </div>
            <br class="clear" />
        </div>
        ...
        <div class="one">
            <div class="one_half_bg" style="padding:80px;">
                <h2 class="ppb_title" style="">{{__('home.air.arab.title')}}</h2>
                <div class="ppb_header_content">
                    <p>{{__('home.air.arab.one')}}</p>
                    <p>{{__('home.air.arab.two')}}</p>
                </div>
            </div>
            <div class="one_half_bg parallax" style="background-image:url({{asset('images/air/two.jpg')}});height:550px;"></div>
            <br class="clear" />
        </div>

        <div class="one">
            <div class="one_half_bg parallax" style="background-image:url({{asset('images/air/three.jpg')}});height:550px;"></div>
            <div class="one_half_bg" style="padding:80px;">
                <h2 class="ppb_title" style="">{{__('home.air.port.title')}}</h2>
                <div class="ppb_header_content">
                    <p>{{__('home.air.port.one')}}</p>
                </div>
            </div>
            <br class="clear" />
        </div>
