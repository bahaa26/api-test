...
<body class="home page-template-default page page-id-3075 woocommerce-no-js ppb_enable">
    ...
    <div class="ppb_wrapper  ">
        ...
        <div class="one withsmallpadding ppb_header_youtube withbg parallax"  style="padding-top: 150px !important;text-align:center;height:800px;background-image:url({{asset('images/air/banner_c.jpg')}});background-position: center center;color:#ffffff;">
            <div class="overlay_background" style="background:#000000;background:rgb(0,0,0,0.5);background:rgba(0,0,0,0.5);"></div>
            <div class="standard_wrapper">
                <div class="page_content_wrapper">
                    <div class="inner">
                        <div style="margin:auto;width:60%; margin-top: 10vw;">
                            <h2 class="ppb_title" style="color:#ffffff;"> {{__('pages.who')}} <span style="color: #ed2027;">{{__('home.slide.two')}}</span></h2>
                            <div class="page_tagline" style="color:#ffffff;">{{__('pages.about.one')}}</div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="one withsmallpadding ppb_header " style="text-align:center;padding:50px 0 50px 0;background-color:#c4191f;color:#ffffff;">
            <div class="standard_wrapper">
                <div class="page_content_wrapper">
                    <div class="inner">
                        <div style="margin:auto;width:50%">
                            <h2 class="ppb_title" style="color:#ffffff;">{{__('pages.about.title')}}</h2>
                            <div class="ppb_header_content">
                                <div class="one_half " style="">
                                    <div class="animate_counter_wrapper">
                                        <div id="15722574381434579802" class="odometer" style="font-size:60px;line-height:60px;">3690</div>
                                ...
                                <div class="one_half last " style="">
                                    <div class="animate_counter_wrapper">
                                        <div id="15722574381897655566" class="odometer" style="font-size:60px;line-height:60px;">6840</div>
                                        <div class="count_separator"><span></span></div>
